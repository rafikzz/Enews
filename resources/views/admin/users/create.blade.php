            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="px-3">
                            <input class="form-check-input" type="radio" name="role" value="superadmin" @if (old('type') == 'superadmin') checked @endif>
                            <label class="form-check-label">Super Admin  </label>
                        </div>
                        <div class="px-3">
                            <input class="form-check-input" type="radio" name="role" value="admin" @if (old('type') == 'admin') checked @endif>
                            <label class="form-check-label">Admin</label>

                        </div>
                        <div class="px-3">
                            <input class="form-check-input" type="radio" name="role" value="user" @if (old('type') !== 'admin' || old('type') !== 'superadmin') checked @endif >
